...
<div class="container-fluid">
    <h1 class="shadow text-center rounded btn btn-outline-secondary" style="width: 18rem;">CREAR FUNCIONARIO</h1>
</div><br>
<div class="container">
    <form action={{ route('funcionarios.index') }} method="POST">
        ...
        <input class="form-control" type="text" name="ap_materno" id="ap_materno" required><br>
