...
<div class="container-fluid">
    ...
    background: linear-gradient(90deg, rgba(35,34,40,1) 0%, rgba(75,75,83,1) 35%, rgba(208,209,209,1) 100%);"><b>FUNCIONARIOS</b></h1>
</div><br>
<div class="container">
    <a href="{{ route('funcionarios.create') }}" class="btn btn-outline-primary">CREAR</a>
