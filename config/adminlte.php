...
return [
    ...
    */
    ...
    'menu' => [
        ...
        /*['header' => 'Administración de Módulos'],
        [
            'text'        => 'ROLES',
            'url'         => 'roles',
        ...
        ['header' => 'Administración de Cuenta'],
        [
            'text' => 'profile',
            'url'  => 'admin/settings',
            'icon' => 'fas fa-fw fa-user',
        ...
        'Chartjs' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdnjs.cloudflare.com/ajax/libs/Chart.js/4.2.0/chart.min.js',
                ],
            ],
        ],
        'Sweetalert2' => [
